...
class QueryDataset(Dataset):
    ...
    def __init__(
        ...
        self.pred_answers = [item["ranked_answers"] for item in df]
        # self.pred_answers = [item["pred_answers"] for item in df]
        self.answer_probs = [item["a_probs"] for item in df]
...
def create_prompt_dataset(local_rank,
    ...
    fname = f"{fname}_phase{train_phase}_seed{seed}_tokenizer{tokenizer_name}_seqlen{max_seq_len}_sft{sft_cache_key}_rewards"
