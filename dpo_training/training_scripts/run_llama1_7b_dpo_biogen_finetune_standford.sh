...
OUTPUT1=./dpo_llama1_7b_generation_biogen_lr_e_6_epoch_standford
...
deepspeed --master_port 12350 main_biogen_dpo_generation_standford_epoch.py \
   --data_path /user/svetzhang/cali_data0826/generation_task/biogen/multi_infer1/train/llama1_7b/generated_questions/standford_ans_samples/records_biogen_llama1_7b_dpo_generation_train_len50_sampled_probs.json \
   --data_eval_path /user/svetzhang/cali_data0826/generation_task/biogen/multi_infer1/train/llama1_7b/generated_questions/standford_ans_samples/records_biogen_llama1_7b_dpo_generation_train_len50_sampled_probs.json \
