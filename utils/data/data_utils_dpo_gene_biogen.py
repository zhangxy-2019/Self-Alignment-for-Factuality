...
def get_stack_exchange_paired(
    ...
    final_df = []
    for i, (query, item_generations) in enumerate(zip(queries, generations)):
        gene_len = len(item_generations)
        pos_res = item_generations[: int(percentage * gene_len)]
        neg_res = item_generations[int(percentage * gene_len) :]
