...
class DPODataCollatorWithPadding:
    ...
    def tokenize_batch_element(
        ...
        """
        self.max_prompt_length = self.max_length -1
        batch = {}
        chosen_tokens = self.tokenizer(chosen)
        rejected_tokens = self.tokenizer(rejected)
        ...
        # Create labels
        chosen_sequence_tokens = self.tokenizer(chosen_sequence)
        rejected_sequence_tokens = self.tokenizer(rejected_sequence)
