...
class QueryDataset(Dataset):
    ...
    def __getitem__(self, i):
        return dict(queries=self.queries[i], query_attn_masks=self.query_attn_masks[i], pad_token_id=self.pad_token_id, tf_queries=self.tf_queries[i], ans_list=self.ans_list[i])
...
def create_prompt_dataset(local_rank,
    ...
    fname = f"{fname}_phase{train_phase}_seed{seed}_tokenizer{tokenizer_name}_seqlen{max_seq_len}_sft{sft_cache_key}"
