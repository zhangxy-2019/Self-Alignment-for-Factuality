...
from utils.data.data_utils_dpo_gene_biogen_standford import create_prompt_dataset, MiniDataset, DataCollatorRLHF, get_unsupervised_data
...
def create_datasets(args, tokenizer, train_phase=3):
    ...
    prompt_train_dataset = create_prompt_dataset(
        ...
        args.data_output_path, train_phase, args.seed, tokenizer,
        args.max_prompt_seq_len, args.few_shot_prompts, args.percentage)
