...
class QueryDataset(Dataset):
    ...
    def __init__(
        ...
        for prompt in prompts:
            ...
            for key_word in ["input_ids", "attention_mask"]:
                y = prompt_token[key_word][:, -(max_seq_len-1):]
    ...
    def __getitem__(self, i):
        return dict(queries=self.queries[i], query_attn_masks=self.query_attn_masks[i], pad_token_id=self.pad_token_id, answer_probs=self.answer_probs[i])
...
class DataCollatorRLHF:
    ...
    def __call__(self, data):
        ...
        batch["prompt_answer_probs"] = [f["answer_probs"] for f in data]
        # batch["prompt_mclabel"] = prompt_mclabel
